...
const assignments = [
  {
    ...
    assignedDate: "2026-04-05T10:00:00",
    status: "pending",
  ...
  },
  {
    ...
    assignedDate: "2026-04-01T09:00:00",
    status: "completed",
    ...
    maxMarks: 30,
    marksReceived: 27,
    submittedAt: "2026-04-14T18:32:00",
  ...
  },
  {
    ...
    assignedDate: "2026-04-10T11:00:00",
    status: "pending",
  ...
  },
  {
    ...
    assignedDate: "2026-04-08T14:00:00",
    status: "pending",
  ...
  },
  {
    ...
    assignedDate: "2026-04-02T10:00:00",
    status: "completed",
    ...
    maxMarks: 20,
    marksReceived: 18,
    submittedAt: "2026-04-11T16:45:00",
    submittedFiles: [
  ...
  },
  {
    ...
    assignedDate: "2026-04-12T09:30:00",
    status: "pending",
...
app.get('/api/dashboard', (req, res) => {
  res.json({
    user: userProfile,
    recentAssignments: assignments.slice(0, 2).map(a => ({
      id: a.id, title: a.title, course: a.course, dueDate: a.dueDate, status: a.status
    })),
...
app.get('/api/assignments', (req, res) => {
  const summary = assignments.map(a => ({
    ...
    dueDate: a.dueDate, status: a.status, maxMarks: a.maxMarks,
    marksReceived: a.marksReceived, submittedAt: a.submittedAt
  }));
...
app.get('/api/profile', (req, res) => {
  res.json({ profile: userProfile, totalCourses: courses.length });
});
...
app.get('/api/results', (req, res) => {
  const semesters = Object.keys(examResults);
  res.json({ semesters, results: examResults, cgpa: userProfile.cgpa });
});
